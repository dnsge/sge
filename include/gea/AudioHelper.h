...
public:
    ...
    static inline int Mix_PlayChannel498(int channel, Mix_Chunk* chunk, int loops) {
        std::cout << "(Mix_PlayChannel498(" << channel << ",?," << loops << ") called on frame "
    ...
    static inline void Mix_Pause498(int channel) {
        std::cout << "(Mix_Pause498(" << channel << ") called on frame " << Helper::GetFrameNumber()
                  << ")" << std::endl;
    ...
    static inline int Mix_Volume498(int channel, int volume) {
        std::cout << "(Mix_Volume498(" << channel << "," << volume << ") called on frame "
                  << Helper::GetFrameNumber() << ")" << std::endl;
